...
class LeaderboardScreenController extends GetxController {
  ...
  getResults() async {
    var url = 'https://api.sportsplits.com/v2/races/$raceId/events/${selectedEvent.value}/leaderboards/leaderboard/results/${category == -1 && gender == -1 ? 'gender/1' : (category != -1 && gender != -1 ? 'gender/$gender/category/$category' : (category != -1 ? 'category/$category' : ('gender/$gender')))}/overall?page=$page${search != '' ? '&search=$search' : ''}';
